...
const GAME_BADGES = {
  FREEFIRE: "bg-sky-500/20 text-sky-400 border-sky-500/40",
  BGMI: "bg-amber-500/20 text-amber-400 border-amber-500/40",
  VALORANT: "bg-red-600/20 text-red-400 border-red-500/40",
};
...
export default function TeamDetailsModal({ isOpen, onClose, team }) {
  ...
  const gameBadgeStyle = GAME_BADGES[team.game?.toUpperCase()] || GAME_BADGES.VALORANT;
      ...
      <div className="relative w-full max-w-lg overflow-hidden rounded-2xl bg-black border border-white/15 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="relative border-b border-white/10 bg-black p-5 sm:p-6">
          ...
          <div className="flex items-start gap-4">
            <div 
              className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-black border border-white/20 overflow-hidden shadow-inner"
        ...
        <div className="grid grid-cols-4 divide-x divide-white/10 border-b border-white/10 bg-white/[0.02]">
          ...
          <div className="p-2.5 text-center">
            <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 flex items-center justify-center gap-1">
              <Swords size={11} className="text-slate-400" /> Matches
            </p>
            <p className="text-base sm:text-lg font-bold font-display text-white mt-0.5">
          ...
          <div className="p-2.5 text-center">
            ...
            <p className="text-base sm:text-lg font-bold font-display text-emerald-400 mt-0.5">
              {team.wins || 0}
            </p>
          </div>
          <div className="p-2.5 text-center">
        ...
        {/* Roster Section */}
        <div className="p-5 sm:p-6 space-y-4 max-h-[60vh] overflow-y-auto bg-black">
          {/* Leader Banner */}
